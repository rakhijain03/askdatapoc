view: call_info_to_merge_feb1_29 {
  sql_table_name: `cci_covid.CallInfo_ToMerge_Feb1_29`
    ;;
  ...
  dimension: call_start_time_stamp {
    type: string
    sql: ${TABLE}.Call_Start_TimeStamp ;;
  }

  dimension_group: call_start_time_temp {
    type: time
    timeframes: [
      raw,
      time,
    ...
    sql: ${TABLE}.Call_Start_Time_Temp ;;
  }
